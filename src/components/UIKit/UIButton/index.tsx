  ...
  return (
    <button
      className={classNames(
        "active:[#0582ca] inline-block rounded border border-[#0582ca] bg-[#0582ca] px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-[#0582ca] focus:outline-none focus:ring",
        className
      )}
      onClick={onClick}
    >
